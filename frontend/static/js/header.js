...
(function () {
  ...
  var widgetHTML = ''
    ...
    +       '<div style="font-size:15px;font-weight:600;color:#f1f5f9;font-family:\'Fira Code\',monospace;">Admin User</div>'
    +       '<div style="font-size:12px;color:#00e5ff;margin-top:2px;font-family:\'Fira Code\',monospace;letter-spacing:0.5px;">PLATFORM_ADMIN</div>'
    +     '</div>'
    +     '<a href="/profile.html"'
    +       ' style="display:flex;align-items:center;gap:8px;padding:8px 12px;border-radius:8px;'
    +         'text-decoration:none;font-size:15px;font-weight:500;color:#94a3b8;transition:background 0.15s;"'
    ...
    +       ' style="display:flex;align-items:center;gap:8px;padding:8px 12px;border-radius:8px;'
    +         'font-size:15px;font-weight:500;color:#475569;background:none;border:none;'
